...
public class NaverBlogIframeCrawler {
    public static void main(String[] args) throws InterruptedException {
        // 1) 첫 번째 URL (iframe src를 가져올 대상)
        String firstUrl = "https://blog.naver.com/dhkdalrl80767/223770241703";
        ...
        System.out.println("Extracted Iframe src: " + iframeSrc);
        ...
        System.out.println("Final Title: " + title.split(" : ")[0]);
    }
}
