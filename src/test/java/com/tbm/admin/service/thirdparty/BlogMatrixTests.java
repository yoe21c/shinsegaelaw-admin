...
@Slf4j
public class BlogMatrixTests {

    @Test
    public void testGetLoginPage() throws Exception {

        String blogId = "imvgw28841";
    ...
    private static CrawlingData loadingLandingPage(CrawlingData crawlingData) {
        ...
        System.out.println("Auth0 Value: " + auth0Value);
...
// Output the extracted post details
        for (PostDetail detail : postDetails) {
            ...
            System.out.println("Data Size: " + detail.getDataSize());
            System.out.println();
        }
        ...
        for (Element bsccntElement : bsccntElements) {
            ...
            System.out.println("bsccnt -->>> " + bsccnt);
