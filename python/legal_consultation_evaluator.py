...
⚠️ 매우 중요: 모든 텍스트 값(description, recommendations, gaps, improvements 등)은 반드시 한글로 작성하세요.
영어로 응답하지 마세요. 오직 한글로만 응답하세요.
...
중요: 모든 텍스트 필드(expertise_gaps, training_needs 등)는 반드시 한글로 작성하세요."""
...
중요: 모든 텍스트 필드(relationship_potential 등)는 반드시 한글로 작성하세요."""
...
중요: 모든 텍스트 필드(executive_summary, strengths, weaknesses, action_items 등)는 반드시 한글로 작성하세요."""

        prompt += "\n\n⚠️ 다시 한번 강조: 모든 응답은 한글로 작성하세요. 영어로 작성하지 마세요.\n\n대화 데이터:\n"
